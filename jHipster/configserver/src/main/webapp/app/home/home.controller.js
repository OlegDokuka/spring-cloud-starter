(function() {
    ...
    HomeController.$inject = ['$scope', 'Principal', 'LoginService', '$state', 'ApplicationsService', 'JhiHealthService'];

    function HomeController ($scope, Principal, LoginService, $state, ApplicationsService, JhiHealthService) {
        var vm = this;
